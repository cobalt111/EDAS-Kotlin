...
class ExamineeProfileRecyclerViewAdapter// Provide a suitable constructor (depends on the kind of dataset)
    (var assessmentList: List<Assessment>) : RecyclerView.Adapter<ExamineeProfileRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExamineeProfileRecyclerViewAdapter.ViewHolder {
        // create a new view
